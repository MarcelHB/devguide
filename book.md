...
* Do not mix scales. High-level models should remain high-level, and similar intermediate- and low-level models. Nobody ever looks at everything at once, but only at what is the required point of entry. Add information that is essential, but skip what better fits into some more detailed view.
